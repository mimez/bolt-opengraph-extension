...
namespace Bolt\Extension\Mimez\OpenGraph\Tests;

use Bolt\Tests\BoltUnitTest;
use Bolt\Extension\Mimez\OpenGraph\OpenGraphExtension;
...
class ExtensionTest extends BoltUnitTest
{
    ...
    public function testExtensionBasics()
    {
        ...
        $extension = new OpenGraphExtension($app);

        $name = $extension->getName();
        $this->assertSame($name, 'OpenGraph');
